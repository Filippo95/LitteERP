...
public class Constants {
  ...
  public static final String TEST_MAIL = "";
  public static final String[] MAIL_GATEWAYS = {""};
  ...
  public static final String DB_PASSWORD          = "edef";  
  public static final String DB_CONNECTION_STRING = "jdbc:mysql://localhost/Progetto?user="+DB_USER_NAME+"&password="+DB_PASSWORD;
    
  /* Constants for log files*/
  public final static String LOG_DIR = "/home/filippo/LogGestionale";
  ...
  public static final String MD5_KEY = "MyERP";
